...
<div class="mb-4">
    <a href="{{ route('pesanans.show', $pesanan) }}" class="btn btn-sm btn-outline-secondary">
    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                Edit Pesanan <span class="text-muted fw-normal">— {{ $pesanan->nomor_pesanan }}</span>
            </div>
            <div class="card-body">
                <form action="{{ route('pesanans.update', $pesanan) }}" method="POST" id="formPesanan">
                    @csrf @method('PUT')
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="jasa_kurir" class="form-select @error('jasa_kurir') is-invalid @enderror" required>
                                ...
                                <option value="{{ $k }}" {{ old('jasa_kurir', $pesanan->jasa_kurir) === $k ? 'selected' : '' }}>{{ $k }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" name="ongkir" id="ongkir" class="form-control"
                                value="{{ old('ongkir', $pesanan->ongkir) }}" min="0">
                        </div>
                        <div class="col-md-8">
                            <label class="form-label">Catatan</label>
                            <input type="text" name="catatan" class="form-control"
                                value="{{ old('catatan', $pesanan->catatan) }}" placeholder="Catatan tambahan (opsional)">
                        </div>
                    </div>
                        ...
                        <div class="row g-2 mb-2 produk-row align-items-center">
                            ...
                            <div class="col-7 col-md-2">
                                <input type="number" name="jumlah[]" class="form-control jumlah-input"
                                    placeholder="Qty" min="1" value="{{ $detail->jumlah }}" required>
                            </div>
                    ...
                    <div class="mt-4 d-flex gap-2">
                        ...
                        <a href="{{ route('pesanans.show', $pesanan) }}" class="btn btn-outline-secondary">Batal</a>
                    </div>
                </form>
            </div>
        </div>
